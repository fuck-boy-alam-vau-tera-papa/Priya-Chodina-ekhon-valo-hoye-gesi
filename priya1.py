...
def banner():
	clear()
	sol()
	ban=''' © FUCK BOY ALAMGIR

     _    _        _    __  __  ____ ___ ____  
    / \  | |      / \  |  \/  |/ ___|_ _|  _ \ [â€¢] FUCK BOY ALAMGIR
   / _ \ | |     / _ \ | |\/| | |  _ | || |_) |[â€¢] What'sApp: 01712034653
  / ___ \| |___ / ___ \| |  | | |_| || ||  _ < 
 /_/   \_\_____/_/   \_\_|  |_|\____|___|_| \_\[â€¢] FUCK BOY ALAMGIRðŸ¥ºâ¤ï¸   '''
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	cetak(nel('[bold cyan]               Game STRT SOO WAIT AND SEE😂[bold cyan]')) 
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{b}ALAMGIR-->{P}[{k}{loop}{P}/{h}{len(id)}{P}]—{P}[{H}{ok}{P}]—{P}[{k}{cp}{x}]—[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
